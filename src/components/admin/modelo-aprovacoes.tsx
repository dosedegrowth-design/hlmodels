...
import { Plus, X, Award, Upload, Image as ImageIcon } from "lucide-react";
    ...
    <div className="bg-white rounded-xl border border-border p-6">
      ...
      <div className="flex flex-wrap gap-2 mb-4">
        {aprovacoes.map((a) => (
          ...
          >
            {a.marca_logo ? (
              <Image src={a.marca_logo} alt={a.marca_nome} width={20} height={20} className="object-contain" />
            ) : (
      ...
      <div className="space-y-3">
        ...
        <div className="flex items-center gap-3">
          ...
          {!logoFile && (
            <span className="text-[10px] text-muted">Opcional — aparece no site no lugar do texto</span>
          )}
        </div>
      </div>
    </div>
