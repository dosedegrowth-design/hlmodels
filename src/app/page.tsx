        ...
        <div className="max-w-[1600px] mx-auto">
          <ScrollReveal>
            <div className="px-6 lg:px-10 mb-10">
              ...
              <h2 className="font-display text-5xl md:text-6xl font-normal tracking-tight">Categorias</h2>
            </div>
          </ScrollReveal>
          ...
          <div className="px-6 lg:px-10 max-w-[1600px] mx-auto">
            <ScrollReveal>
              <div className="mb-10">
                ...
                <h2 className="font-display text-5xl md:text-6xl font-normal tracking-tight">Nossos Talentos</h2>
              </div>
            </ScrollReveal>
          ...
          <div className="max-w-[1600px] mx-auto">
            <ScrollReveal>
              <div className="px-6 lg:px-10 mb-10">
                ...
                <h2 className="font-display text-5xl md:text-6xl font-normal tracking-tight">Aprovados</h2>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal>
              <div className="flex items-end justify-between mb-10">
                <div>
                  ...
                  <h2 className="font-display text-5xl md:text-6xl font-normal tracking-tight">Projetos</h2>
                </div>
        ...
        <div className="max-w-[1600px] mx-auto">
          <ScrollReveal>
            <div className="px-6 lg:px-10 mb-10 text-center">
              ...
              <h2 className="font-display text-5xl md:text-6xl font-normal tracking-tight">Marcas Parceiras</h2>
            </div>
          </ScrollReveal>
          <BrandsCarousel />
        </div>
      ...
      <section className="bg-foreground text-white py-14 md:py-20 px-6">
        <div className="max-w-3xl mx-auto text-center">
          <ScrollReveal>
            ...
            <h2 className="font-display text-5xl md:text-6xl font-normal tracking-tight mb-6">Faça Parte</h2>
          </ScrollReveal>
        ...
        <div className="px-6 lg:px-10 max-w-[1600px] mx-auto">
          <ScrollReveal>
            <div className="text-center mb-12">
              ...
              <h2 className="font-display text-5xl md:text-6xl font-normal tracking-tight">Perguntas Frequentes</h2>
            </div>
          </ScrollReveal>
          <FaqSection />
        </div>
