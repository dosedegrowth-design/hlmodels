...
export default function AdminLoginPage() {
  ...
  return (
    <div className="min-h-screen relative flex items-center justify-center p-6 overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_bottom_left,_rgba(255,255,255,0.04)_0%,_transparent_50%)]" />

      {/* Decorative lines */}
      <div className="absolute top-0 left-1/4 w-px h-full bg-white/[0.03]" />
      <div className="absolute top-0 right-1/3 w-px h-full bg-white/[0.03]" />
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <p className="text-center text-[10px] text-white/10 mt-6 uppercase tracking-[0.2em]">
          Acesso restrito
        </p>
      </div>
    </div>
